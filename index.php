            ...
            if (host=="") alert("HostIP is empty");
                ...
                $.ajax({
                    ...
                    success: function(data, status, xhr) {
                        ...
                        transcode_video = 'trancode URL: <a href="http://'+xhr.getResponseHeader('Info')+'">http://' + xhr.getResponseHeader('Info') +'<a/><br/><video width="320" height="240" loop autoplay controls="true" > <source src=' + xhr.getResponseHeader('Info') + ' > Your browser does not support the video tag. </video> <embed type="application/x-vlc-plugin"        name="video1"         autoplay="no" loop="yes" width="320" height="240"         target="http://'+xhr.getResponseHeader('Info')+'" /><br/>'
